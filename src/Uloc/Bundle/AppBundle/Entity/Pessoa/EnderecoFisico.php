...
class EnderecoFisico
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Uloc\Bundle\AppBundle\Entity\App\Pais")
     ...
     * Muitos Enderecos tem Um Uloc\Bundle\AppBundle\Entity\App\Municipio.
     * @ORM\ManyToOne(targetEntity="Uloc\Bundle\AppBundle\Entity\App\Municipio", inversedBy="enderecos")
     * @ORM\JoinColumn(name="municipio_id", referencedColumnName="id")
     */
    private $municipio;

    /**
     * Muitos Enderecos tem Um Pessoa.
